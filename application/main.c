...
#define ADDRESS     	"192.168.178.178"
...
int main(int argc, char *argv[]){
	...
	while(i<nMeas) {
		...
		if(data.status & BME680_HEAT_STAB_MSK)
		{
			...
			publish(client, "BME680 TEMPERATURE", "211,25");
			publish(client, "BME680 PRESSURE", "211,25");
			publish(client, "BME680 HUMIDITY", "211,25");
			publish(client, "BME680 GAS_RESISTANCE", "211,25");
